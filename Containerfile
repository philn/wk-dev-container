...
ENV WEBKIT_CONTAINER_SDK_DISABLE_AUTOENTER=1
...
RUN git clone http://github.com/Sparkle-CDM/sparkle-cdm && \
    git -C sparkle-cdm checkout 2026.2 && \
