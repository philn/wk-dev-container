...
#!/bin/sh
set -eu
flatpak-spawn --host podman start wk-dev-f39
exec flatpak-spawn --host podman exec -e WEBKIT_HOME=$HOME/WebKit -i -u phil \
     wk-dev-f39 webkit-clangd --enable-config --gtk "$@"
```
